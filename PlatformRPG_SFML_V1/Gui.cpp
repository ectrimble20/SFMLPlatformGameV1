...
Gui::Gui()
{
	guiSystem.emplace("rightClickMenu", GuiContainer(sf::Vector2f(128, 16), 2, false, "menuButton",
		{
	...
	guiSystem.emplace("mainMenu", GuiContainer(sf::Vector2f(384, 48), 8, false, "menuButton",
		{
